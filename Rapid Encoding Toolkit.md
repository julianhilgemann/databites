...
*   **The Method:**
    ...
    3.  **The Drill:** Explain the **Architecture**.
        *   *Bad:* "Star schema is better because it has facts and dims."
        *   *Good:* "I chose a Star Schema to optimize for the **VertiPaq engine**, which compresses narrow columns better than wide tables. It also allows us to use standard **Time Intelligence** functions without complex DAX workarounds."
...
*   **The Adjustment:** Leverage your Figma/Design skills. Don't just draw the tables; draw the **Pipeline**.
...
*   **The Method:**
    ...
    2.  **Prompt:** "Build a YoY calculation that handles context transition correctly."
...
*   **The Adjustment:** Focus purely on the high-level vocabulary that justifies your 2 years of experience.
*   **The Cards:**
    *   *Front:* "Why use TMDL?" $\to$ *Back:* "To enable Git merge conflict resolution and code-first bulk editing."
