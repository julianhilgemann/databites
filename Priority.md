...
*   **🚀 Specialist Nuance:** **"Auto Date/Time."**
    ...
    *   *The Answer:* "Absolutely not. It creates hidden tables for every date column and bloats the model. I always build a dedicated `DimDate` table."
...
>
> In **Power BI**, I focus on building a clean Semantic Model—using **1-to-Many single-direction relationships**, hiding surrogate keys, and using **DAX Measures** (not calculated columns) for business logic.
>
